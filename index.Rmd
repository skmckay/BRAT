...
#Specify test cases
Table02[1,] <- c("Iins", 0, 0, 0, 0, 0, 0)
Table02[2,] <- c("Iins", 1000, 0, 1, 0, 0, 0)
Table02[3,] <- c("Ihab", 0,1000,1, 0, 0, 0)
Table02[4,] <- c("Iins", 0, 0, 0, 0, 0, 0)
Table02[5,] <- c("Iins", 1000, 0, 1, 0, 0, 0)
Table02[6,] <- c("Ihab", 0,1000,1, 0, 0, 0)
Table02[7,] <- c("Iins", 0, 0, 0, 0, 0, 0)
Table02[8,] <- c("Iins", 1000, 0, 1, 0, 0, 0)
Table02[9,] <- c("Ihab", 0,1000,1, 0, 0, 0)

#Send output table
rownames(Table02) <- NULL
knitr::kable(Table02, caption="Table 2. Test matrix for BRAT.", align="c") 
```
