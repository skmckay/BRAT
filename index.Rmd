--- 
title: "A rapid,desktop model for riparian assessment"
...
github-repo: USACE-WRISES/Riparian.Tier0.Model
---
...
# PROJECT TIMELINE AND DUTIES {-}

Early July 2023. Meta-analysis underway.

July 2023. Meta-analysis results complete. 

August 1 - Draft of suitability curves (Kyle and Rosamar). 

August 7-11, 2023. Set up ecorest and function (Darixa). 

August 18. Draft introduction and justifications for each suitability curve (Rosamar and Kyle). 

August 21 - September 4. Darixa and Rosamar work together to test models and conduct simple sensitivity analysis. Writing the model evaluation section. 

September 6-21. Kyle and Rosamar work together on a sample model application.

September 6. Ask Colton for help adding this model to the riparian webapp.

September 21.  Target for a complete draft of model document.

October. Submit the model for review with the Eco-PCX.
