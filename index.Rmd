...
S. Kyle McKay, Ph.D., P.E., Woolpert, Inc., New York, NY, [kyle.mckay@woolpert.com](kyle.mckay@woolpert.com)

Rosamar Ayala Torres, Environmental Laboratory, Vicksburg, MS, [rosamar.ayala-torres@erdc.dren.mil](rosamar.ayala-torres@erdc.dren.mil)
...
plot(c(0,100), c(0,1), type="n", xlim=c(0,100), ylim=c(0,1),
     xlab="Average Buffer Width (m)", ylab="(A) Instream Suitability", main="SI.ins")
...
plot(c(0,100), c(0,1), type="n", xlim=c(0,100), ylim=c(0,1),
     xlab="Minimum Buffer Width (m)", ylab="Instream Suitability", main="(D) SI.min")
...
The corridor metric for BRAT is simpler than the instream and habitat metrics, and this metric is based on significantly less empirical data (i.e., it was not developed from a global meta-analysis). These metrics are arithmatically averaged and not weighted to account for these assumptions. Thus, the overall corridor suitability may be calculated as:
...
Model development was funded by the U.S. Army Corps of Engineers' Ecosystem Management and Restoration Research Program ([EMRRP](https://emrrp.el.erdc.dren.mil/)). The authors are grateful to Garrett Menichino, Sam Wiest, and Colton Shaw for their broader contributions to an EMRRP study of riparian ecological modeling and their roles in assisting with the web application. This model was reviewed by Garrett Menichino, Sam Wiest, and Mick Porter as part of USACE model certification (**PENDING**). Opinions expressed here are those of the authors and not necessarily those of the agencies they represent.
